    ...
    <main id="conteudo">
      <section className="hero" id="inicio" aria-labelledby="hero-title">
        <div className="hero-copy">
          <p className="eyebrow hero-intro"><span className="gold-line" /> MK ODONTOLOGIA INTEGRADA</p>
      ...
      <section id="sobre" className="about section-pad" aria-labelledby="about-title">
        <div className="section-grid" data-reveal><p className="eyebrow"><span className="gold-line" /> SOBRE A MK</p><div><h2 id="about-title">{site.institutional.aboutTitle}</h2><div className="about-text"><p>{site.institutional.about}</p><p>{site.institutional.aboutComplement}</p></div></div></div>
      </section>

      <section id="especialidades" className="specialties section-pad" aria-labelledby="specialties-title">
        <div className="section-heading" data-reveal><div><p className="eyebrow"><span className="gold-line" /> ESPECIALIDADES</p><h2 id="specialties-title">Encontre informações<br />sobre o seu tratamento.</h2></div><p>Entenda o que cada especialidade avalia<br className="desktop-break" /> e quando procurar orientação.</p></div>
